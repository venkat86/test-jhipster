(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope, $translate) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('sampleappApp.httpError', function (event, httpResponse) {
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-sampleappApp-error');
                var entityKey = httpResponse.headers('X-sampleappApp-params');
                if (errorHeader) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('sampleappApp.' + fieldError.objectName + '.' + convertedField);
